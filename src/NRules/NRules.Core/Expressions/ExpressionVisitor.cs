    ...
    internal abstract class ExpressionVisitor
    {
        protected virtual Expression Visit(Expression exp)
        {
            ...
            switch (exp.NodeType)
            {
                ...
                default:
                    throw new InvalidOperationException(string.Format("Unhandled expression type. Type={0}",
                                                                      exp.NodeType));
            }
        }
            ...
            switch (binding.BindingType)
            {
                ...
                default:
                    throw new InvalidOperationException(
                        string.Format("Unhandled binding type. BindingType={0}", binding.BindingType));
            }
        }
