...
namespace NRules.Fluent.Dsl
{
    public static class QueryExtensions
    {
        ...
        /// <returns>Query expression builder.</returns>
        public static IQuery<IEnumerable<TSource>> OrderBy<TSource, TKey>(this ICollectQuery<TSource> source, Expression<Func<TSource, TKey>> keySelector)
        {
        ...
        /// <param name="keySelector">Key selection expression used for sorting.</param>
        /// <returns>Query expression builder.</returns>
        public static IQuery<IEnumerable<TSource>> OrderByDescending<TSource, TKey>(this ICollectQuery<TSource> source, Expression<Func<TSource, TKey>> keySelector)
        {
        ...
        /// <param name="source">Query expression builder.</param>
        /// <returns>Query expression builder.</returns>
        public static ICollectQuery<TSource> Collect<TSource>(this IQuery<TSource> source)
        {
            source.Builder.Collect<TSource>();
            return new CollectQueryExpression<TSource>(source.Builder);
        }
    }
}