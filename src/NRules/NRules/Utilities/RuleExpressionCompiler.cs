...
internal interface IRuleExpressionCompiler
{
    ...
    ILhsExpression<TResult> CompileLhsExpression<TResult>(ExpressionElement element, IEnumerable<Declaration> declarations);
    ILhsFactExpression<TResult> CompileLhsFactExpression<TResult>(ExpressionElement element);
    ILhsTupleExpression<TResult> CompileLhsTupleExpression<TResult>(ExpressionElement element, IEnumerable<Declaration> declarations);
    IActivationExpression<TResult> CompileActivationExpression<TResult>(ExpressionElement element,
        IEnumerable<Declaration> declarations, IndexMap tupleFactMap);
    IRuleAction CompileAction(ActionElement element, IEnumerable<Declaration> declarations,
        IReadOnlyCollection<DependencyElement> dependencies, IndexMap tupleFactMap);
    IAggregateExpression CompileAggregateExpression(NamedExpressionElement element, IEnumerable<Declaration> declarations);
}
...
internal class RuleExpressionCompiler : IRuleExpressionCompiler
{
    ...
    public ILhsTupleExpression<TResult> CompileLhsTupleExpression<TResult>(ExpressionElement element, IEnumerable<Declaration> declarations)
    {
    ...
    public ILhsExpression<TResult> CompileLhsTupleFactExpression<TResult>(ExpressionElement element, IEnumerable<Declaration> declarations)
    {
        var factMap = IndexMap.CreateMap(element.Imports, declarations);
    ...
    public IRuleAction CompileAction(ActionElement element, IEnumerable<Declaration> declarations,
        IReadOnlyCollection<DependencyElement> dependencies, IndexMap tupleFactMap)
    {
        var activationFactMap = IndexMap.CreateMap(element.Imports, declarations);
        var factMap = IndexMap.Compose(tupleFactMap, activationFactMap);
    ...
    public IAggregateExpression CompileAggregateExpression(NamedExpressionElement element, IEnumerable<Declaration> declarations)
    {
