...
internal class ExpressionElementComparer
{
    ...
    private bool AreParameterPositionsEqual(
        IReadOnlyCollection<Declaration> firstDeclarations, ExpressionElement firstElement,
        IReadOnlyCollection<Declaration> secondDeclarations, ExpressionElement secondElement)
    {
