    ...
    public class SimplePersonalFinancesRule : IRule
    {
        ...
        public void Define(IRuleDefinition definition)
        {
            definition.When()
                ...
                .If<PersonalFinances>(
                    finances => finances.LiquidAssets + finances.YearlyPreTaxIncome >= finances.TotalDebt*0.6m)
                .If<InsuranceApplicant, PersonalFinances>(
                    (applicant, finances) => applicant.PersonalFinances == finances);
